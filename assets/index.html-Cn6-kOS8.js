import{_ as n,c as a,b as e,o as l}from"./app-BBO4DGWY.js";const p={};function i(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h2 id="基本命令" tabindex="-1"><a class="header-anchor" href="#基本命令"><span>基本命令</span></a></h2><ul><li><p>文件处理命令</p></li><li><p>权限管理命令</p></li><li><p>文件搜索命令</p></li><li><p>帮助命令</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">  <span class="token function">man</span> 命令或者配置文件 <span class="token comment"># 查看命令的描述 /选项 查看对应选项的含义</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul>`,14)]))}const r=n(p,[["render",i]]),o=JSON.parse('{"path":"/machine/linux/","title":"","lang":"en-US","frontmatter":{},"git":{"updatedTime":1773751874000,"contributors":[{"name":"lsj","username":"lsj","email":"lishaojie@aithu.com","commits":1,"url":"https://github.com/lsj"}],"changelog":[{"hash":"3d50bcb32ffa6ed29547f22ec8a3e9463299ac87","time":1773751874000,"email":"lishaojie@aithu.com","author":"lsj","message":"更新openclaw"}]},"filePathRelative":"machine/linux/README.md"}');export{r as comp,o as data};
